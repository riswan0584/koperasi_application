               ...
               <section class="panel panel-default">
                ...
                <div class="row wrapper">
                  <div class="col-sm-5 m-b-xs">
                   <button class="btn btn-sm btn-info" ><?php echo anchor('divisi/input','tambah');?></button>
                  </div>
                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    foreach ($divisi as $d) { $no++; 
                      ...
                      <tr>
                       ...
                       <td><a href="<?php echo base_url(); ?>divisi/edit/<?php echo $kode;?>"><img src="<?php echo base_url(); ?>images/edit.png"></a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
