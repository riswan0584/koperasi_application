               ...
               <section class="panel panel-default">
                ...
                <div class="row wrapper">
                  <div class="col-sm-5 m-b-xs">
                   <button class="btn btn-sm btn-info" ><?php echo anchor('kategori/input','tambah');?></button>
                  </div>
                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    foreach ($kategori as $k) { $no++; 
                      ...
                      <tr>
                       ...
                       <td><a href="<?php echo base_url(); ?>kategori/edit/<?php echo $kode;?>"><img src="<?php echo base_url(); ?>images/edit.png"></a></td>
                      </tr>
                    <?php } ?>
                    </tbody>
